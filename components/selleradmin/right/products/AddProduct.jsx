...
function AddProduct({ value, UID }) {
  ...
  useEffect(() => {
    axios.get("https://k-ecom.onrender.com/products/getcategory").then((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    axios
      .post("https://k-ecom.onrender.com/products/addproduct", {
        name: Name,
    ...
    <>
      ...
      >
        ...
        {successfullCreate === true ? (
          <p className="mb-10 text-xl text-green-400">
