...
function DeleteProduct() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://k-ecom.onrender.com/products/findsellerproduct", {
        name: Name,
  ...
  const deleteProduct = (e) => {
    ...
    const Name = name.current.value.toString();
    axios
      .put("https://k-ecom.onrender.com/products/deletesellerproduct", {
        uid: uid.current.value.toString(),
        Name: Name,
  ...
  return (
    <>
      <div className="h-fill">
        ...
        {successfull ? (
          <p className="my-4 text-xl text-center text-red-600">
        ...
        {unsuccess ? (
          <p className="text-xl text-center text-red-600">Product not found</p>
        ) : (
          ""
        )}
      </div>
